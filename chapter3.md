...
> 译者注：Metainfo，即，元信息，是一种专门用于“描述属性的信息”。**种子文件(.torrent files)**的学名叫**元信息文件(Metainfo File)**，表示其内只有对应文件的**元信息**，因而没有真实的文件数据。一个**种子文件**内包含了一个或多个文件资源的**元信息**。
...
- `files` **列表**，包含多个文件的信息，每个文件对应一个 **字典**，这些字典的格式如下：
    - 
